...
-- ----------------------------
BEGIN;
INSERT INTO `client` VALUES ('1', 'yoqu', '123123', 'xinxiang', '1', '0'), ('2', 'aa', '123123', 'xinxiang', '1', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `dictionary` VALUES ('1', '1', 'site_name', 'yoqu的系统', 'final cms系统', '0'), ('2', '1', 'page_size', '20', 'pagesize', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `dictionary_type` VALUES ('1', 'system', '系统字典', '0'), ('2', 'node', 'node字典', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `file` VALUES ('21', null, null, '8b4a353233393135363237070e1.jpg', 'node', '17', '2016-05-19 10:24:06'), ('22', null, null, '8b4a353233393135363237070e2.jpg', null, '-1', '2016-05-19 10:26:08'), ('32', null, null, '8b4a353233393135363237070e3.jpg', 'node', '21', '2016-05-19 10:35:44'), ('33', '8b4a353233393135363237070e4.jpg', '5444', 'E:\\workspace\\fincalcms\\web\\upload', 'node', '-1', '2016-05-19 15:30:45'), ('34', '头像.jpg', '27951', 'E:\\workspace\\fincalcms\\web\\upload', null, '-1', '2016-05-19 15:32:54'), ('35', '头像1.jpg', '27951', 'E:\\workspace\\fincalcms\\web\\upload', null, '-1', '2016-05-19 15:33:39'), ('36', '头像2.jpg', '27951', 'E:\\workspace\\fincalcms\\web\\upload', 'node', '24', '2016-05-19 15:35:45'), ('37', '8b4a353233393135363237070e5.jpg', '5444', 'E:\\workspace\\fincalcms\\web\\upload', null, '-1', '2016-05-19 15:37:50'), ('39', '森林.jpg', '1294604', 'E:\\workspace\\fincalcms\\web\\upload', 'node', '25', '2016-05-19 16:26:46'), ('42', 'idea.desktop', '154', '/media/yoqu/document/workspace/fincalcms/web/upload', 'node', '32', '2016-05-24 14:18:19');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `menu` VALUES ('1', 'index', null, '1', '/admin/dashboard', '-1', '0'), ('2', 'last', null, '1', '/admin/last', '-1', '0'), ('3', 'midlle', null, '1', '/admin/middle', '-1', '0'), ('4', 'chidone', null, '1', '/admin/one', '-1', '0'), ('5', 'childtwo', null, '1', '/admin/two', '-1', '0'), ('6', '第二页面', null, '3', '/admin/dashboard', '-1', '0'), ('7', '第三页面', null, '3', '/admin/about', '-1', '0'), ('8', '第二页面儿子', null, '3', '/admin/erzi', '7', '0'), ('9', '第二页面儿子的儿子', null, '3', '/erzi/erzi', '8', '0'), ('10', '面板', 'mdi-action-dashboard', '4', '/admin/dashboard', '-1', '0'), ('11', '菜单', 'mdi-navigation-menu', '4', '/admin/menu', '-1', '0'), ('12', '权限', 'mdi-action-perm-contact-cal', '4', '/admin/role', '-1', '0'), ('13', '内容管理', 'mdi-content-drafts', '4', '/admin/node', '-1', '0'), ('14', '用户管理', 'mdi-action-account-circle', '4', '/admin/people', '15', '0'), ('15', '用户', 'mdi-action-account-circle', '4', '/admin/people', '-1', '0'), ('16', '添加用户', null, '4', '/admin/people/create', '15', '0'), ('17', '添加菜单', null, '4', '/admin/menu/create', '11', '0'), ('18', '菜单管理', null, '4', '/admin/menu', '11', '0'), ('19', '添加菜单项', null, '4', '/admin/menu/item/create', '11', '0'), ('20', '系统设置', 'mdi-action-settings', '4', '/admin/setting', '-1', '0'), ('21', '变量设置', null, '4', '/admin/setting/systemVariable', '20', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `menu_type` VALUES ('1', '主菜单', '0'), ('3', '修改二级菜单', '0'), ('4', '管理左侧菜单', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `role` VALUES ('1', 'admin', '0'), ('2', 'reporter', '0'), ('3', 'editer', '0');
COMMIT;
...
CREATE TABLE `role_access` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rId` int(11) NOT NULL,
  `access` varchar(50) CHARACTER SET latin1 NOT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `role_access` VALUES ('2', '1', '/admin/*', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `role_permission` VALUES ('8', '1', 'people', 'create', '0'), ('9', '1', 'people', 'index', '0'), ('10', '2', 'people', 'create', '0'), ('11', '3', 'people', 'create', '0'), ('12', '3', 'people', 'index', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `url` VALUES ('1', 'people', 'create', 'org.yoqu.cms.admin.modules.people.Controller', '/admin/people/create', '0'), ('2', 'people', 'index', 'org.yoqu.cms.admin.modules.people.Controller', '/admin/people', '0'), ('3', 'people', 'edit', 'org.yoqu.cms.admin.modules.people.Controller', '/admin/people/edit', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'admin', null, 'yoqulin', '1545', 'yoqulin@qq.com', 'E1:0A:DC:39:49:BA:59:AB:BE:56:E0:57:F2:0F:88:3E', '2016-04-18 16:51:12', '2016-08-26 16:32:49', '1', '0'), ('2', 'zia', null, 'yzuaq', '123123', 'yzxu@ema.com', '123456789', '2016-04-20 17:26:06', '2016-04-20 17:26:06', '1', '1'), ('3', 'tony', null, 'touni', '192281', 'ajzua@qq.com', 'E1:0A:DC:39:49:BA:59:AB:BE:56:E0:57:F2:0F:88:3E', '2016-05-04 16:38:26', '2016-05-09 13:38:51', '2', '0');
COMMIT;
