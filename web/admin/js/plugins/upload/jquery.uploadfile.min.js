    ...
    $.fn.uploadFile = function (options) {
        ...
        this.createProgress = function (data) {
            ...
            if(s.showFileCounter)
                fileNameStr = obj.fileCounter + s.fileCounterStyle + data['data'][0]['name'];
            else fileNameStr = data['data'][0]['name'];


            if(s.showFileSize)
                fileNameStr += " ("+getSizeStr(data['data'][0]['size'])+")";
            ...
            if(s.showPreview)
            {
                pd.preview.attr('src',data['data'][0]['path']);
                pd.preview.show();
            }
            ...
            if(s.showDownload) {
                ...
                pd.download.click(function () {
                    if(s.downloadCallback) s.downloadCallback.call(obj, [data['data'][0]['name']]);
                });
            }
            if(s.showDelete)
            {
